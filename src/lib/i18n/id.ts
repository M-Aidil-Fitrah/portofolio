...
const id: Dictionary = {
  ...
  activities: {
    ...
    admin: {
      ...
      uploadProgressLabel: "Progres unggahan {percent}%",
      ...
      coverUploadingProgress: "Mengunggah cover {percent}%",
      ...
      coverComposer: {
        ...
        rendering: "Menerapkan template",
        rendered: "Template cover diterapkan",
        renderError: "Template cover tidak dapat diterapkan.",
      },
      ...
      previewStudio: {
        eyebrow: "Pratinjau publik langsung",
        tabs: {
          feed: "Feed",
          detail: "Detail",
          gallery: "Galeri",
        ...
        viewportLabel: "Viewport pratinjau",
        languageLabel: "Bahasa pratinjau",
        tabsLabel: "Permukaan pratinjau",
        frameTitle: "Pratinjau publik aktivitas",
        inertHint:
          "Interaksi publik dinonaktifkan dalam pratinjau. Perubahan draf tampil tanpa disimpan.",
        emptyGallery: "Tambahkan gambar atau video untuk melihat galeri.",
        emptyAttachments: "Tambahkan dokumen untuk melihat lampiran.",
        galleryTitle: "Galeri aktivitas",
        attachmentsTitle: "Lampiran aktivitas",
      },
