...
export function ActivityComments({
  ...
  return (
    <div data-activity-comments data-comments-expanded={expanded ? "true" : "false"}>
      <div className="flex items-center justify-between gap-6">
        ...
        <button
          ...
          className="rounded-pill border border-hairline px-4 py-2 font-mono text-[10px] uppercase tracking-widest text-muted transition-colors hover:border-volt hover:text-volt"
        >
          {expanded ? t.activities.hideComments : t.activities.showComments}
        </button>
      </div>
      ...
      {expanded && (
        <>
          <div className="mt-6 flex justify-end border-t border-hairline pt-4">
            ...
            >
              {sortNewest
                ? t.activities.sortNewest
                : t.activities.sortOldest}{" "}
              &darr;&uarr;
            </button>
          </div>

          <ul ref={listRef} className="mt-2 space-y-6">
